...
export function AppointmentBooking() {
  ...
  return (
    <section id="appointment" className="py-5 sm:py-6 bg-mint/10 border-y border-border-main/30 relative overflow-hidden scroll-mt-[108px]">
      {/* Subtle decorations */}
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-3 sm:gap-4 items-center h-[46px]">
                      {["Ayurveda", "Homeopathy", "Both"].map((type) => (
                        <label key={type} className="flex items-center gap-1.5 cursor-pointer group">
                          ...
                          />
                          <span className="text-xs font-semibold text-[#1E293B] group-hover:text-[#028174] transition-colors">
                            {type}
                          </span>
                        </label>
                      ))}
