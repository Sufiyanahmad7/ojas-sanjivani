...
export function TrustIndicators() {
  return (
    <section className="relative py-12 bg-mint/15 border-y border-border-main/40">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TRUST_INDICATORS.map((indicator, index) => (
            ...
            >
              ...
              <div className="text-3xl sm:text-4xl font-black text-primary font-heading tracking-tight mb-1">
                {indicator.value}
              </div>
